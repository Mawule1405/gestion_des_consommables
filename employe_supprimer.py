...
def supprimer(frame):
    ...
    soumettre = ctk.CTkButton(frame, text="Supprimer",width=200, height=40, fg_color = set.col_btn_bg, corner_radius=0,
                              hover_color=set.col_hover, font=('Montsérrat', 20), command= lambda : suppression())
